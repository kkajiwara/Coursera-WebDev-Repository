...
<!-- Book template -->
    ...
    <!-- Sticky top -->
        ...
        <!-- Title and Author -->
          ...
          <p class="col-1 text-left"><a href="#toc_rule">Contents</a></p>
        <!-- Line break -->
...
<!--            <xsl:for-each select="front-matter/toc/toc-entry">-->
<!--                <p class="text-left py-0 my-0"><xsl:value-of select="."/></p>-->
<!--            </xsl:for-each>-->
        </div>
        <!-- Book body chapters -->
...
<!--                <hr style="color:blue;border-width:4px;"/>-->
        <!-- Title -->
                ...
                <div class="row">
                    <p class="col-10 text-primary mb-1">Scroll in the box to read entire chapter.</p>
                    <p class="col-2 text-right mb-1">Next chapter</p>
                </div>
        <!-- Body -->
                <div class="py-3 border" style="height:400px;overflow:scroll;">
...
<!-- Chapter title template -->
    <xsl:template match="book-body/book-part">
        <hr>
            <xsl:attribute name="style">color:blue;border-width:4px;padding-top:8rem;</xsl:attribute>
...
<!-- Italic template -->
    <xsl:template match="book-body/book-part/body/p/italic">
      <span class="fst-italic"><xsl:value-of select="."/></span>
    </xsl:template>
